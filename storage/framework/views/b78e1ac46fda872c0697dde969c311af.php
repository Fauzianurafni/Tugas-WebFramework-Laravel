        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 px-20">
            <?php $__empty_1 = true; $__currentLoopData = $movies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="bg-white border border-gray-200 rounded-lg shadow-lg transition-all duration-300 ease-in-out hover:shadow-xl dark:bg-gray-800">
                    <!-- Poster -->
                    <a href="#">
                        <img class="rounded-t-lg w-full h-64 object-cover" src="<?php echo e(asset('storage/' . $movie->poster)); ?>"
                            alt="<?php echo e($movie->title); ?>">
                    </a>
                    <!-- Movie Details -->
                    <div class="p-5 space-y-2">
                        <h5 class="text-lg font-semibold text-gray-900 dark:text-white"><?php echo e($movie->title); ?></h5>
                        <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($movie->year); ?></p>
                        <p class="text-sm text-gray-700 dark:text-gray-400">
                            <?php echo e(Str::limit($movie->synopsis, 100)); ?>

                        </p>
                        <p class="text-sm text-blue-500 dark:text-blue-400">Genre: <?php echo e($movie->genres->name ?? 'Unknown'); ?></p>
                        <p class="text-sm text-green-500"><?php echo e($movie->available ? 'Available' : 'Not Available'); ?></p>
                    </div>
                    <!-- Actions -->
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="col-span-full text-center">
                    ...
                    <a href="<?php echo e(route('movies.create')); ?>" class="text-blue-600 hover:underline">Add a new movie</a>
                </div>
            <?php endif; ?>
        </div>
    </section>
...
<?php echo $__env->make('Layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Tugas-WebFramework\resources\views/movies/index.blade.php ENDPATH**/ ?>